...
questions: dict[str, dict[str, str]] = {
    "Algebra_1": {"If 2x = 4 what is x?": "2", "If 3x = 9 what is x?": "3",
                  "If x + 2 = 10 what is x?": "8",
                  "If 5y + 2 = 12 what is y?": "2",
    ...
    "Algebra_2": {"If 2x ÷ 10 = 2 what is x?": "10",
                  "If 4y ÷ 2 = 12 what is y?": "6",
                  "If 6x - 4 = 32 what is x?": "6",
                  "If 12z - 5 = 19 what is z?": "2",
                  "If 8y x 3 = 24 what is y?": "1",
                  "What is x if 2(x + 1) = 18?": "8",
                  "What is z if 8z x 3 = 48?": "2",
                  "4(x + 2) = 24 what is x?": "4",
                  "If 3x = 20 - 8 what is x?": "4",
    ...
    "Fractions_2": {"What is 5/12 ÷ 2/3?": "5/8", "What is 4/9 x 3/7?": "4/21",
                    "What is 15/4 x 8/3?": "10",
                    "What is 18/25 x 15/24?": "9/20",
                    "What is 14/27 ÷ 7/9?": "2/3",
                    "What is 11/15 - 5/8?": "13/120",
                    "What is 7/9 x 5/6?": "35/54", "Simplify 24/36": "2/3",
                    "Simplify 35/50": "7/10", "Simplify 14/21": "2/3"},
    "Fractions_3": {"What is 2/3(1/5 + 3/4)?": "19/30",
                    "What is 3/4(1/2 + 1/3)?": "5/8",
                    "What is 5/6(2/5 + 1/4?)?": "13/24",
                    "What is 4/5(3/8 + 1/2)?": "7/10",
                    "What is 2/3(1/4 + 3/5)?": "17/30",
                    "What is 5/6(2/5 - 1/4?)?": "1/8",
                    "What is 3/5(1/4 - 2/3)?": "1/10",
                    "What is 4/7(2/3 x 1/6)?": "4/63",
                    "What is 3/4(1/5 + 1/2)?": "21/40",
    ...
    "Basic_A_3": {"What is 8 x 7 ÷ 14?": "4", "What is 12 x 5 ÷ 15 + 2?": "6",
                  "What is 9 x 4 - 6 ÷ 3?": "34",
                  "What is 10 + 6 x 2 ÷ 4?": "13",
                  "What is 14 x 3 ÷ 7- 1?": "5",
                  "What is 16 - 8 x 2 ÷ 4?": "12",
                  "What is 20 x 9 ÷ (15 + 3)?": "10",
                  "What is (18 - 6) x 5 ÷ 2?": "30",
...
def algebra(question_info: dict[str, str], hearts: int) -> int:
    ...
    for question in question_info.keys():
        ...
        if user_answer == answer:
            correct_answers += 1
            print(f"Correct! Test hearts: {hearts + 1 if hearts < 5 else hearts}")
            if hearts < 5:
                hearts += 1
        else:
            hearts -= 1
